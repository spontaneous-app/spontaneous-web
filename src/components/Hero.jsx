  ...
  return (
    <div className="space-y-6">
      <motion.div
        ...
        className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass text-orange-300 text-sm font-medium"
      >
      ...
      >
        ...
        <br />
        <span className="text-white">with Daily Prompts</span>
      </motion.h1>
